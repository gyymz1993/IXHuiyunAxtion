...
import com.huiyun.ixhuiyunaxtion.crypt.RC4;
...
public class JsonPack {
	...
	public static byte[] Data_Unpack(int length, byte[] in_buf){
	    ...
	    if(in_buf[0] == (byte) 0xfe &&
	    		(byte)((crc_temp>>8) & 0xff) == in_buf[dataLen+4] &&
	    		(byte)(crc_temp & 0xff) == in_buf[dataLen+5] &&
