...
public class Data {
	...
	public static final int FUNC_CODE_HEART_BEAT       = 252;
	public static final int FUNC_CODE_HEART_BEAT_RETURN = 253;
	public static final int FUNC_CODE_WIFI_STATE       = 254;
	...
	// 功能码(新红外)
	//
	public static final int FUNC_CODE_REDCODE_LEARN      = 33;
	public static final int FUNC_CODE_REDCODE_LEARN_RE   = 34;
	public static final int FUNC_CODE_REDCODE_CONTROL    = 31;
	public static final int FUNC_CODE_REDCODE_CONTROL_RE = 32;
	...
	public static final int LENGTH_REDRAY   = 200;
	...
	// 接收数据、缓存的容量,以及其它
	//
	public static final int MAX_RECEIVE_LENGTH = 10240;
	public static final int BUFFER_CAPACITY    = 20480;
